      ...
      <div className="relative isolate min-h-screen px-4 py-6 md:px-6 md:py-10">
        <div className="absolute inset-0 opacity-90">
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="h-[84vh] w-full max-w-5xl bg-[url('/daha-sengen-main-visual.png')] bg-contain bg-center bg-no-repeat opacity-[0.38] md:h-[104vh] md:max-w-[88rem] md:opacity-[0.5]" />
          </div>
